...
#define LOG_PEOPLELISTVIEWCONTROLLER(...)   do{}while(0)
#define LOG_MIME_MEGUESSMENUVIEWCONTROLLER(...) do {} while (0)

#define LOG_MIME_MEGUESSMENUVIEWCONTROLLER(...) do {} while (0)
#define LOG_MIME_MEGUESSFULLTABLEVIEWCONTROLLER(...) do {} while (0)
#define LOG_MIME_MECREATEMIMEVIEWCONTROLLER(...) do {} while (0)

#define LOG_MIME_MEFRIENDPICKERVIEWCONTROLLER(...) do {} while (0)
#define LOG_MIME_MEFRIENDLISTTABLEVIEWCONTROLLER(...) do {} while (0)
#define LOG_MIME_MESCRAPBOOKMENUVIEWCONTROLLER(...) do {} while (0)
